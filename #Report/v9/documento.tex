...
\end{figure}
\\
Adiciona-se a nota de que existe outra lógica de suporte que não pertence a nenhuma das duas abstrações anteriormente apresentadas, tal como geradores de pulsos.
