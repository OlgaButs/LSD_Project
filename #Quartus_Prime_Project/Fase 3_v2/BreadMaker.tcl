...
# File: BreadMaker.tcl
# Generated on: Sat May 27 15:25:39 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "BreadMaker"]} {
		puts "Project BreadMaker is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists BreadMaker]} {
		project_open -revision BreadMaker BreadMaker
	} else {
		project_new -revision BreadMaker BreadMaker
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "11:07:03  MAY 21, 2023"
	...
	set_global_assignment -name VHDL_FILE Logic_Blocks/DE2_LCD_DISPLAY.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Debugger_InputsAt50MHZ.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Mux3_1.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/ROM_KxN_1P_V2.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Mux2_1.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/BinToBCD.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Bin7SegDecoder.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/TimerN.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/TimeExtra.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Counter.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/PulseGenN.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/TimerAuxFSM.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/Debouncer.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/ControlSystemUnit_v2.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/FlipFlopD.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/BreadBakerFSM.vhd
	set_global_assignment -name VHDL_FILE Logic_Blocks/ROM_KxN_1P_V1.vhd
	set_global_assignment -name BDF_FILE BreadMaker.bdf
