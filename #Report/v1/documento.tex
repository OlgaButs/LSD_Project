...
%%%%%% RESUMO %%%%%%
\begin{abstract}
Os alunos da Unidade Curricular de Laboratórios de Sistemas Digitais (\textit{LSD}, código 40333) da Licenciatura em Engenharia de Computadores e Informática (\textit{LECI}, código 8316) da Universidade de Aveiro (\textit{UA}) foram propostos ao desenvolvimento de um Projeto Final que contempla três componentes: desenvolvimento do sistema digital de uma \textit{Máquina Automática de Fazer Pão} (Projeto Número 8, Versão 2), criação de um relatório do desenvolvimento anteriormente referido, e a defesa do projeto perante um Juri.
\\\\
Neste sentido, apresenta-se neste documento o relatório do desenvolvimento do sistema digital de uma \textit{Máquina Automática de Fazer Pão} (Versão 2 do Projeto 8) de acordo com as competências adquiridas na Unidade Curricular de LSD.
\end{abstract}
